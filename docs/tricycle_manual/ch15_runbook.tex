...
\code{NameNotFound: Environment ... doesn't exist} & Entry point not installed or stale: Chapter~\ref{ch:pyproject}, Section~\ref{sec:step_cli}. \\
gym registry empty after import & Missing \code{__init__.py} then reinstall: Chapters~\ref{ch:pyproject}, \ref{ch:agents}. \\
